...
public class PairIntensity extends ApplicationFrame {
	...
	public PairIntensity (String s) throws FileNotFoundException, IOException, ParseException, org.json.simple.parser.ParseException{
		super(s);
	...
	public static JPanel createDemoPanel() throws FileNotFoundException, IOException, ParseException, org.json.simple.parser.ParseException{
		...
		JFreeChart jfreechart = ChartFactory.createScatterPlot("Sation Pair Intensity",
				"Station Pairs", 
				"Intensity", 
				samplexydataset(), 
	...
	private static XYDataset samplexydataset() throws FileNotFoundException, IOException, ParseException, org.json.simple.parser.ParseException{
		...
		double[] intensity = new double[sym.length*(sym.length-1)/2+sym.length];
		int k=0;
		...
		for(int i=0; i<intensity.length; i++){
			if (intensity[i]>0){series0.add(i, 
	...
	public static void main(String args[]) throws FileNotFoundException, IOException, ParseException, org.json.simple.parser.ParseException{
		PairIntensity  scatterplotdemo4 = new PairIntensity ("Sation Pair Intensity");
